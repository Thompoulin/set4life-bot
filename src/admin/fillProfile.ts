...
const QUESTION_KEYWORD_MAP: Array<{ slug: string; match: (t: string) => boolean }> = [
  ...
  { slug: "wasFiredRegulations", match: (t) => /permitted you to resign|terminated your contract or appointment/i.test(t) },
  { slug: "wasFiredOfFraud", match: (t) => /permitted you to resign|terminated your contract or appointment/i.test(t) },
  { slug: "wasFiredStatutes", match: (t) => /permitted you to resign|terminated your contract or appointment/i.test(t) },
  ...
  { slug: "suretyRefused", match: (t) => /surety/i.test(t) },
  { slug: "eoRefused", match: (t) => /errors\s*(?:&|and)\s*omissions|e&o/i.test(t) },
  ...
  { slug: "secNonInsuranceLicense", match: (t) => /license as an attorney|attorney, accountant|federal contractor/i.test(t) },
...
const getSlugQuestionPattern = (slug: string): string => {
  const map: Record<string, string> = {
    ...
    wasFiredRegulations: "permitted you to resign|terminated your contract or appointment",
    wasFiredOfFraud: "permitted you to resign|terminated your contract or appointment",
    wasFiredStatutes: "permitted you to resign|terminated your contract or appointment",
    ...
    suretyRefused: "surety",
    eoRefused: "errors\\s*(?:&|and)\\s*omissions|e&o",
    ...
    secNonInsuranceLicense: "license as an attorney|attorney, accountant|federal contractor",
