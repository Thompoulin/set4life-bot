 ...
 */
export async function bulkProcessBga(browser, input, parentLogger) {
 ...
 */
async function harvestBearerToken(page, producerId, logger) {
    return new Promise((resolve) => {
        ...
        page
            ...
            .catch((err) => logger.warn({ err: err?.message }, "harvestBearerToken: pushState threw"));
        // Hard timeout 15 s.
        setTimeout(() => {
            if (!resolved) {
                resolved = true;
